...
describe('SftpClientAdapter', () => {
  ...
  it('passes through connect/end/fastGet/fastPut/posixRename/delete/mkdir/list to the raw client unchanged', async () => {
    const calls: string[] = [];
    ...
    expect(await adapter.mkdir('/var/www/app', true)).toBe('mkdir-result');
